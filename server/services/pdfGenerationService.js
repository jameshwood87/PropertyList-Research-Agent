...
class PDFGenerationService {
  ...
  buildFooterSection() {
    return `
    <div class="footer">
        <p>This report was generated by AI Property Research Agent | PropertyList.es MLS Data | Generated on ${new Date().toLocaleString('en-GB')}</p>
        <p>© ${new Date().getFullYear()} Property Analysis System. This report is for information purposes only.</p>
    </div>
    `;
  }
